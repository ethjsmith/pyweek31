...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        ...
        #self.image = pygame.Surface((70, 50), pygame.image.load("starship.png"))
        self.image = pygame.image.load("starship.png")
        #pygame.draw.polygon(self.image, (50, 120, 180), ((35, 0), (0, 35)))
        pygame.draw.rect(self.image, (100,100,100),((100,100),(200,200)))
